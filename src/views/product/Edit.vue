        ...
        <div class="row" style="margin-top:20px">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="submit" id="update-form" :action="apiUrl+'/products'" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Title</label>
                                        <input type="text" v-model="product.title" name="title" class="form-control" :class="errors.hasOwnProperty('title') ? 'is-invalid' : ''">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" v-model="product.price" class="form-control" :class="errors.hasOwnProperty('price') ? 'is-invalid' : ''">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="" cols="30" rows="10" v-model="product.description"></textarea>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <img :src="storageUrl + '/' + product.image" style="border:1px solid #ededed;padding : 6px;width:200px;height:auto" alt="">
                                    </div>
                                </div>
                            </div>
                        </form>
...
export default{
   ...
   methods:{
       getProduct(id){
           axios.get(`${this.apiUrl}/products/${id}`).then(res=>{
       ...
       submit(){
           ...
           axios.post(`${this.apiUrl}/products/${this.product.id}`, formData).then(res => {
               ...
               else if(err.response.status.code == 401){
                   this.$router.push({path : '/login'});
               }
               showMessage('error', err.response.data.message)
           })
